...
SOURCE = HERE / "chapter03.md"
OUTPUT = HERE / "第03章_操作系统简介_审阅稿_v0.1.docx"
...
def configure_header_footer(doc: Document) -> None:
    ...
    run = fp.add_run("第3章 操作系统简介 · 独立审阅稿  |  ")
    set_font(run, size=9, color=GRAY)
    add_page_field(fp)
...
def main():
    ...
    doc.core_properties.title = "第3章 操作系统简介"
    doc.core_properties.subject = "boomPI 独立章节审阅稿"
    doc.core_properties.author = "尚硅谷嵌入式项目"
    doc.core_properties.keywords = "boomPI, RV1106G3, 操作系统, Linux, 内核"
    add_cover(doc)
