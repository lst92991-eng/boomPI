...
SOURCE = HERE / "chapter02.md"
OUTPUT = HERE / "第02章_原理图介绍_审阅稿_v0.2.docx"
...
def configure_header_footer(doc: Document) -> None:
    ...
    run = fp.add_run("第2章 原理图介绍 · 独立审阅稿  |  ")
    set_font(run, size=9, color=GRAY)
    add_page_field(fp)
...
def main():
    ...
    doc.core_properties.title = "第2章 原理图介绍"
