...
> 当前候选的语音核心为 18 个生产 C/C++ 文件、2620 ELOC；其中
> Rockchip/Snowboy vendor 集成 280 ELOC，产品逻辑 2340 ELOC；UI 显示层另计 1926 ELOC，不占语音核心预算。屏幕/触摸、网络启动、UDP
...
2026-08-03 教学候选按仓库既定职责整理；语音核心为 18 个生产 C/C++ 文件、2620 ELOC，其中
Rockchip/Snowboy vendor 集成为 280 ELOC，产品逻辑为 2340 ELOC；UI 显示层（LVGL 渲染与屏幕/触摸驱动）另计 1926 ELOC：
