...
3. **P2 本地音频（进行中）**：48/16 kHz、后端契约、24→48 kHz 软件 renderer、portable sink/accepted ledger/committer，以及固定 playback mailbox 和取消 ACK join 已建立；真实单播放 worker、network producer/DSP endpoint、ALSA adapter、AEC/BF/VAD、Snowboy adapter、正常 EOS 播放完成、打断闭环和 HIL 仍待完成。
